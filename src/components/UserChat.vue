                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a class="dropdown-item d-flex justify-content-between align-items-center"
                                                    href="#">Archive
                                                    <i class="bx bx-archive text-muted"></i></a>
                                                <a class="dropdown-item d-flex justify-content-between align-items-center"
                                                    href="#">Muted <i class="bx bx-microphone-off text-muted"></i></a>
                                                <a class="dropdown-item d-flex justify-content-between align-items-center"
                                                    href="#">Delete
                                                    <i class="bx bx-trash text-muted"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="chat-input-links me-md-2">
                                        ...
                                        <!--Emoji Picker Here-->
                                        <div class="links-list-item emoji-dropdown" data-bs-toggle="tooltip"
                                            ...
                                            <div v-if="constPicker" class="emoji-picker"
                                                style="position: absolute; background: white; border: 1px solid #ddd; padding: 10px; z-index: 100;">
                                                <div class="emoji-list">
                                                    <span v-for="emoji in emojis" :key="emoji"
                                                        @click="selectEmoji(emoji)" class="emoji-item"
                                                        style="font-size: 24px; border: none; background: none; cursor: pointer;">
                                                        {{ emoji }}
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="col">
                                    <div class="position-relative">
                                        ...
                                        <div class="chat-input-typing">
                                            <span class="typing-user d-flex">Sagar Dhakal
                                                is
                                                typing
