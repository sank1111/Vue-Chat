          ...
          <li class="nav-item dropdown profile-user-dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item d-flex align-items-center justify-content-between"
                href="auth-changepassword.html">Change Password <i class="bx bx-lock-open text-muted ms-1"></i></a>
          ...
          <div class="modal-body p-0 overflow-hidden">
            ...
            <div class="position-absolute video-call-menu start-0 end-0 bottom-0 mb-3">
              <div class="hstack justify-content-center gap-3">
                ...
                <button type="button" class="btn btn-danger avatar-sm call-close-btn shadow-none rounded-circle"
                  data-bs-dismiss="modal">
                  <span class="avatar-title bg-transparent fs-24">
                    <i class="mdi mdi-phone-hangup"></i>
                  </span>
              ...
              <div class="mb-4">
                ...
                <div class="mb-3">
                  <button class="btn btn-light btn-sm" type="button" data-bs-toggle="collapse"
                    data-bs-target="#groupmembercollapse" aria-expanded="false" aria-controls="groupmembercollapse">
                    Select Members
                  </button>
                </div>
        ...
        <div class="modal-content modal-header-colored border-0">
          ...
          <div class="modal-body p-4">
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-shrink-0">
                <div>
                  <button type="button" class="btn btn-sm btn-warning"><i class="bx bx-plus align-middle"></i>
                    Pin</button>
                </div>
              </div>
            </div>
                ...
                <li>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                      <h5 class="fs-14 text-truncate mb-1"><a href="#" class="p-0">design-phase-1-approved.pdf</a>
                      </h5>
    ...
    <ul class="list-unstyled mb-0 vstack gap-2">
      <li>
        <a data-bs-toggle="offcanvas" href="#theme-settings-offcanvas"
          class="settings bg-success-subtle text-success rounded"><i class="mdi mdi-cog mdi-spin"></i></a>
      </li>
      <li>
        <a href="javascript:void(0);" class="settings bg-danger-subtle text-danger text-danger rounded"><i
        ...
        <div class="col-6">
          <div class="form-check card-radio">
            <input id="customizer-color08" name="bgcolor-radio" type="radio" value="color08"
              class="form-check-input theme-color">
            <label class="form-check-label customizer-color08 p-0 avatar-md w-100" for="customizer-color08"></label>
          </div>
